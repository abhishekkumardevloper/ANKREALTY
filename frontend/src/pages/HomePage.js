...
const API_BASE = import.meta.env.VITE_API_URL || 'ankrealty-production.up.railway.app';
      ...
      <section className="relative pt-32 pb-24 px-4 md:px-6 overflow-hidden min-h-[90vh] flex flex-col justify-center">
        ...
        <div className="relative z-20 max-w-6xl mx-auto text-center mt-10 w-full">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="space-y-6">
            <motion.div
              variants={fadeUp}
              className="inline-flex items-center gap-2 mb-2 px-5 py-2 rounded-full border border-[#D4AF37]/40 bg-[#D4AF37]/10 backdrop-blur-sm text-[#D4AF37] text-sm font-bold tracking-widest uppercase shadow-[0_0_20px_rgba(212,175,55,0.2)]"
            >
            ...
            <motion.h1
              variants={fadeUp}
              className="text-4xl md:text-6xl lg:text-7xl font-black text-white leading-[1.1] tracking-tight uppercase drop-shadow-lg"
            >
              Discover premium properties across{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D4AF37] to-[#AA8000]">India</span>
            </motion.h1>

            <motion.p
              variants={fadeUp}
              className="text-lg md:text-xl lg:text-2xl text-slate-300 max-w-3xl mx-auto font-medium leading-relaxed drop-shadow-md"
            >
          ...
          <motion.div
            ...
            className="mt-14 bg-white/95 backdrop-blur-xl rounded-[2rem] shadow-2xl p-4 md:p-6 max-w-5xl mx-auto border border-[#D4AF37]/20 text-left relative z-30"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-3 relative">
              ...
              <Button
                ...
                className="w-full h-14 bg-[#8B0000] hover:bg-[#600000] hover:-translate-y-0.5 transition-all duration-300 text-white font-black text-base rounded-xl shadow-lg shadow-[#8B0000]/30"
              >
          ...
          >
            <div>
              <p className="text-[#8B0000] font-bold uppercase tracking-[0.25em] text-xs mb-3 flex items-center gap-2">
                <Award className="w-4 h-4" /> Featured inventory
              </p>
              <h2 className="text-3xl md:text-5xl font-black text-slate-900">Verified properties tailored for you</h2>
            </div>
            <Link to="/properties">
              <Button variant="outline" className="border-slate-300 font-bold hover:bg-[#8B0000] hover:text-white transition-colors h-12 px-6 rounded-xl text-base">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16 max-w-2xl mx-auto">
            ...
            <p className="text-slate-600 mt-4 max-w-2xl mx-auto text-lg leading-relaxed">
              Plan your property purchase with confidence. Estimate your monthly mortgage payments instantly.
            </p>
          </div>
            ...
            <div className="space-y-8 relative z-10">
              <div>
                ...
                <input
                  ...
                  className="w-full h-2 bg-slate-300 rounded-lg appearance-none cursor-pointer accent-[#8B0000]"
                />
              </div>
