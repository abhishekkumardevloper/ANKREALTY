    ...
    <div className="min-h-screen bg-gray-50 font-sans text-gray-900 selection:bg-red-100 selection:text-red-900">
      ...
      >
        ...
        <div className="relative z-20 w-full max-w-5xl px-6 text-center mt-10">
          ...
          {/* Search Widget */}
          <div className="bg-white/95 backdrop-blur-md rounded-xl shadow-2xl p-2 md:p-6 max-w-4xl mx-auto transform hover:-translate-y-1 transition-all duration-300" data-testid="search-widget">
            {/* Tabs */}
