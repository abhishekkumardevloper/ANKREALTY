...
-- -----------------------------
-- Helpful seed admin example
-- Replace password with a bcrypt hash generated by the backend if needed.
-- -----------------------------
...
-- -----------------------------
-- Optional: enable RLS later if you plan to call Supabase directly from the frontend.
-- Current backend design expects the API server to mediate access.
-- -----------------------------